...
import { CirclePlus, Ellipsis, MapPin, Search, Trash } from "lucide-react";
...
const JobPost: React.FC = () => {
  ...
  const [showAddJobPostModal, setShowAddJobPostModal] =
  ...
  const filteredJobs = jobs.filter((job) => {
    ...
    return (
      ...
      employer?.firstname?.toLowerCase().includes(lowerSearch) ||
    ...
    <>
      <div className="py-4 px-8 max-w-7xl">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center">
          <h1 className="text-xl font-bold mb-4 sm:mb-0">Job Post</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
          ...
          <div
            className="border-2 border-gray-100 rounded-xl h-80 flex flex-col items-center justify-center gap-4 shadow-lg hover:shadow-2xl transition-shadow cursor-pointer"
            onClick={() => setShowAddJobPostModal(true)}
          >
            <CirclePlus className="bg-slate-100 text-gray-600 rounded-full p-2 h-10 w-10" />
            <Button className="h-8 border-2 border-gray-300 text-sm rounded-full bg-white hover:bg-gray-50">
              Create a Job Post
            </Button>
          </div>
      ...
      {showAddJobPostModal && (
        <AddJobPostModal
          showAddJobPostModal={showAddJobPostModal}
          setShowAddJobPostModal={setShowAddJobPostModal}
